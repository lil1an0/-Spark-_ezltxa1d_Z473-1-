<template>
	<div class="content" :style='{"alignContent":"flex-start","padding":"0 0 53px 0","overflow":"hidden","background":"url(http://codegen.caihongy.cn/20250104/f5f3c3bf499641a9ad7b02fcf340b381.png) no-repeat bottom center,url(http://codegen.caihongy.cn/20250104/74fb86808f734214b656ff6e6baff933.png) no-repeat top center,rgb(3, 12, 59)","flexDirection":"column","display":"flex","width":"100%","position":"relative","height":"100%"}'>
		...
		<div :style='{"padding":"15px 0 0","margin":"0","background":"url(http://codegen.caihongy.cn/20250104/a6f8e90a837b4c2eb8601823d839286f.png) no-repeat top center","display":"flex","width":"100%","position":"relative","justifyContent":"center","height":"98px","zIndex":"2"}'>
			...
			<!-- 时间 -->
			<div :style='{"top":"65px","color":"#d0e1f3","display":"inline-block","lineHeight":"44px","fontSize":"16px","position":"absolute","right":"12%","height":"44px"}'>{{ dates }} <span @click="backClick" style="cursor:pointer;padding: 0 0 0 8px;">管理界面</span></div>
		</div>
		<div :style='{"padding":"0","flex":"auto","background":"url(http://codegen.caihongy.cn/20250104/81d376bb600349c6bb9ee3b9e2a3bade.png) no-repeat left center / 180px 100%,url(http://codegen.caihongy.cn/20250104/faebd1e099b7458bb5291b776236cd99.png) no-repeat right center / 170px 100%","display":"flex","width":"100%","justifyContent":"space-between","height":"0","zIndex":"9"}'>
			<div :style='{"width":"25%","padding":"0","flexDirection":"column","display":"flex","gap":"10px"}'>
				<div class="echarts2">
					<div :style='{"padding":"0 0 0 30px","margin":"0 0 0 160px","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250104/98a6bbd24bd24c75a26b8a0a8f28b0ca.png) no-repeat left center / 278px 36px","flex":"none","width":"calc(100% - 160px)","height":"36px"}'>
					...
					<div :style='{"width":"100%","padding":"0 0 0 120px","flex":"auto","height":"0"}'>
						<div id="qixiangshujuChart2" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts5">
					<div :style='{"padding":"0 0 0 30px","margin":"0","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250104/98a6bbd24bd24c75a26b8a0a8f28b0ca.png) no-repeat left center / 278px 36px","flex":"none","width":"100%","height":"36px"}'>
						<div :style='{"fontSize":"20px","lineHeight":"36px","color":"#fff","textAlign":"left","background":"none","fontWeight":"500"}'>
							风向占比
						</div>
					</div>
					<div :style='{"width":"100%","padding":"0 0 0 40px","flex":"auto","height":"0"}'>
						<div id="qixiangshujuChart5" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts6">
					<div :style='{"padding":"0 0 0 30px","margin":"0","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250104/98a6bbd24bd24c75a26b8a0a8f28b0ca.png) no-repeat left center / 278px 36px","flex":"none","width":"100%","height":"36px"}'>
					...
					<div :style='{"width":"100%","padding":"0 0 0 40px","flex":"auto","height":"0"}'>
						<div id="qixiangshujuChart6" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
			<div :style='{"width":"50%","padding":"0","flexWrap":"wrap","flexDirection":"row","display":"flex"}'>
				<!-- 统计 -->
				<div :style='{"padding":"0 10px","margin":"0 0 10px 0","color":"#fff","alignItems":"center","display":"flex","justifyContent":"center","alignContent":"center","background":"none","gap":"10px","width":"100%","fontSize":"14px","height":"58px","order":"1"}'>
					...
					<div :style='{"padding":"0 10px","margin":"0","alignItems":"center","background":"url(http://codegen.caihongy.cn/20250104/9308fb76b74e4fa5be5d28c2f3ad95a4.png) no-repeat center top / 100% 100%","flexDirection":"column","flex":"1 1 auto","display":"flex","width":"150px","position":"relative","justifyContent":"center","height":"58px","maxWidth":"240px"}'>
						...
						<div :style='{"padding":"0","alignItems":"center","flexDirection":"row","display":"flex","gap":"6px","width":"100%","justifyContent":"space-evenly","height":"100%"}'>
							<div :style='{"color":"inherit","fontSize":"14px","height":"auto"}'>气象数据总数</div>
							<div :style='{"lineHeight":"44px","fontSize":"16px","color":"rgb(66, 144, 247)","fontWeight":"bold","height":"40px","order":"20"}'>{{qixiangshujuCount}}</div>
						</div>
					</div>
					...
					<div :style='{"padding":"0 10px","margin":"0","alignItems":"center","background":"url(http://codegen.caihongy.cn/20250104/9d069865e5b64db8ab5e104ff7567af0.png) no-repeat center top / 100% 100%","flexDirection":"column","flex":"1 1 auto","display":"flex","width":"150px","position":"relative","justifyContent":"center","height":"58px","maxWidth":"240px"}'>
						...
						<div :style='{"padding":"0","alignItems":"center","flexDirection":"row","display":"flex","gap":"6px","width":"100%","justifyContent":"space-evenly","height":"100%"}'>
							<div :style='{"color":"inherit","fontSize":"14px","height":"auto"}'>地图总数</div>
							<div :style='{"lineHeight":"44px","fontSize":"16px","color":"rgb(212, 107, 8)","fontWeight":"bold","height":"40px","order":"20"}'>{{dituCount}}</div>
						</div>
					</div>
				</div>
				<div :style='{"margin":"0","color":"#fff","alignItems":"center","background":"none","display":"flex","width":"60%","justifyContent":"center","height":"calc(60% - 68px)","order":"2"}'>
					<div id="dituMapChart1" style="width:100%;height:100%;"></div>
				</div>
				<div class="echarts1">
					<div :style='{"padding":"0 0 0 30px","margin":"0 0 0px","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250104/98a6bbd24bd24c75a26b8a0a8f28b0ca.png) no-repeat left center / 278px 36px","flex":"none","width":"100%","height":"36px"}'>
						<div :style='{"fontSize":"20px","lineHeight":"36px","color":"#fff","textAlign":"left","background":"none","fontWeight":"500"}'>
							地区占比
						</div>
					</div>
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="qixiangshujuChart1" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts8">
					<div :style='{"padding":"0 0 0 30px","margin":"0 0 0px","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250104/98a6bbd24bd24c75a26b8a0a8f28b0ca.png) no-repeat left center / 278px 36px","flex":"none","width":"100%","height":"36px"}'>
					...
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="qixiangshujuChart8" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts9">
					<div :style='{"padding":"0 0 0 30px","margin":"0 0 0px","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250104/98a6bbd24bd24c75a26b8a0a8f28b0ca.png) no-repeat left center / 278px 36px","flex":"none","width":"100%","height":"36px"}'>
					...
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="qixiangshujuChart9" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
			<div :style='{"width":"25%","padding":"0","flexWrap":"wrap","flexDirection":"column","display":"flex","gap":"10px"}'>
				<div class="echarts3">
					...
					<div :style='{"width":"100%","padding":"0 80px 0 0","flex":"auto","height":"0"}'>
						<div id="qixiangshujuChart3" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts4">
					<div :style='{"padding":"0 0 0 30px","margin":"0 0 0px","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250104/98a6bbd24bd24c75a26b8a0a8f28b0ca.png) no-repeat left center / 278px 36px","flex":"none","width":"100%","height":"36px"}'>
					...
					<div :style='{"width":"100%","padding":"0 75px 0 0","flex":"auto","height":"0"}'>
						<div id="qixiangshujuChart4" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts7">
					<div :style='{"padding":"0 0 0 30px","margin":"0 0 0px","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250104/98a6bbd24bd24c75a26b8a0a8f28b0ca.png) no-repeat left center / 278px 36px","flex":"none","width":"100%","height":"36px"}'>
					...
					<div :style='{"width":"100%","padding":"0 110px 0 0","flex":"auto","height":"0"}'>
						<div id="qixiangshujuChart7" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
		</div>
	...
	export default {
		...
		created() {
			this.$nextTick(()=>{
				this.times()
				setTimeout(()=>{
					this.getqixiangshujuCount();
					this.qixiangshujuChat1();
					this.qixiangshujuChat8();
					this.qixiangshujuChat3();
					this.qixiangshujuChat4();
					this.qixiangshujuChat9();
					this.qixiangshujuChat6();
					this.qixiangshujuChat7();
					this.qixiangshujuChat2();
					this.qixiangshujuChat5();
					this.getdituCount();
					this.dituMapChat1();
				},500)
			})
		...
		methods:{
			...
			getqixiangshujuCount() {
				this.$http({
					url: `qixiangshuju/count`,
					method: "get"
				}).then(({
					data
				}) => {
					if (data && data.code == 0) {
						this.qixiangshujuCount = data.data
					}
				})
			},
			//统计接口1
			qixiangshujuChat1() {
				this.$nextTick(()=>{
					...
					this.$http({
						url: "group/qixiangshuju/diqumingcheng",
						method: "get",
					}).then(({ data }) => {
						if (data && data.code === 0) {
							let res = data.data;
							...
							var option = {};
							this.wordclouds(pArray,'qixiangshujuChart1');
			...
			qixiangshujuChat8() {
				this.$nextTick(()=>{
					...
					var qixiangshujuChart8 = echarts.init(document.getElementById("qixiangshujuChart8"),'macarons');
					this.$http({
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							qixiangshujuChart8.setOption(option);
				
							this.myChartInterval(1, option.xAxis.data, option.series[0].data, qixiangshujuChart8)

							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								qixiangshujuChart8.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
			...
			qixiangshujuChat3() {
				this.$nextTick(()=>{
					...
					var qixiangshujuChart3 = echarts.init(document.getElementById("qixiangshujuChart3"),'macarons');
					this.$http({
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							qixiangshujuChart3.setOption(option);
				

							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								qixiangshujuChart3.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
			...
			qixiangshujuChat4() {
				this.$nextTick(()=>{
					...
					var qixiangshujuChart4 = echarts.init(document.getElementById("qixiangshujuChart4"),'macarons');
					this.$http({
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							qixiangshujuChart4.setOption(option);
				

							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								qixiangshujuChart4.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
			...
			qixiangshujuChat9() {
				this.$nextTick(()=>{
					...
					var qixiangshujuChart9 = echarts.init(document.getElementById("qixiangshujuChart9"),'macarons');
					this.$http({
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							qixiangshujuChart9.setOption(option);


							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								qixiangshujuChart9.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
			...
			qixiangshujuChat6() {
				this.$nextTick(()=>{
					...
					var qixiangshujuChart6 = echarts.init(document.getElementById("qixiangshujuChart6"),'macarons');
					this.$http({
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							qixiangshujuChart6.setOption(option);

							this.myChartInterval(2, option.yAxis.data, option.series[0].data, qixiangshujuChart6)

							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								qixiangshujuChart6.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
			...
			qixiangshujuChat7() {
				this.$nextTick(()=>{
					...
					var qixiangshujuChart7 = echarts.init(document.getElementById("qixiangshujuChart7"),'macarons');
					this.$http({
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							qixiangshujuChart7.setOption(option);


							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								qixiangshujuChart7.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
			...
			qixiangshujuChat2() {
				this.$nextTick(()=>{
					...
					var qixiangshujuChart2 = echarts.init(document.getElementById("qixiangshujuChart2"),'macarons');
					this.$http({
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							qixiangshujuChart2.setOption(option);


							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								qixiangshujuChart2.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
			...
			qixiangshujuChat5() {
				this.$nextTick(()=>{
					...
					var qixiangshujuChart5 = echarts.init(document.getElementById("qixiangshujuChart5"),'macarons');
					this.$http({
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							qixiangshujuChart5.setOption(option);


							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								qixiangshujuChart5.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
			...
			dituMapChat1() {
				this.$nextTick(()=>{
					...
					var dituMapChart1 = echarts.init(document.getElementById("dituMapChart1"),'macarons');
					...
					this.$http({
						...
						if (data && data.code === 0) {
							...
							dituMapChart1.setOption(option);
							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								dituMapChart1.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
