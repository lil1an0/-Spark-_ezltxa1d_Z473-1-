<template>
	<div class="home-content">
		...
		<div class="statis-box">
			<div id="statis1" class="statis1 animate__animated" v-if="isAuth('qixiangshuju','首页总数')">
				<div class="left">
					<span class="icon iconfont icon-zhangjie8"></span>
				</div>
				<div class="right">
					<div class="num">{{qixiangshujuCount}}</div>
					<div class="name">气象数据总数</div>
				</div>
			</div>
			<div id="statis2" class="statis2 animate__animated" v-if="isAuth('ditu','首页总数')">
				<div class="left">
					<span class="icon iconfont icon-chujia3"></span>
				</div>
				<div class="right">
					<div class="num">{{dituCount}}</div>
					<div class="name">地图总数</div>
				</div>
			</div>
		</div>
		<!-- statis -->
		...
		<!-- 5 -->
		<div class="type5">
			<div id="qixiangshujuChart1" class="echarts1 animate__animated" v-if="isAuth('qixiangshuju','首页统计')"></div>
			<div id="qixiangshujuChart2" class="echarts2 animate__animated" v-if="isAuth('qixiangshuju','首页统计')"></div>
			<div id="qixiangshujuChart3" class="echarts3 animate__animated" v-if="isAuth('qixiangshuju','首页统计')"></div>
			<div id="qixiangshujuChart4" class="echarts4 animate__animated" v-if="isAuth('qixiangshuju','首页统计')"></div>
			<div id="qixiangshujuChart5" class="echarts5 animate__animated" v-if="isAuth('qixiangshuju','首页统计')"></div>
		</div>
	</div>
</template>
<script>
...
export default {
	...
	mounted(){
		...
		if(this.isAuth('qixiangshuju','首页统计')){
	...
	methods:{
		handleScroll() {
			let arr = [
				...
				{id:'qixiangshujuChart1',css:'animate__fadeInUp'},
				{id:'qixiangshujuChart2',css:'animate__fadeInUp'},
				{id:'qixiangshujuChart3',css:'animate__fadeInUp'},
				{id:'qixiangshujuChart4',css:'animate__fadeInUp'},
				{id:'qixiangshujuChart5',css:'animate__fadeInUp'},
			]
...
<style lang="scss" scoped>
	.home-content {
		...
		background: url(http://codegen.caihongy.cn/20250307/1b87a3bf09e24d58b0c251bfa2297205.png) no-repeat center top / cover;
		display: flex;
		width: 100%;
		min-height: 100vh;
