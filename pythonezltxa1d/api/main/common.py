...
def before_request():
    ...
    if request.method == 'GET':
        get_list = [
            "/",
            "/apidocs/",
             "/pythonezltxa1d/examusers/login" ,
            "/pythonezltxa1d/examusers/register",
            '/pythonezltxa1d/defaultuser/login',
            '/pythonezltxa1d/users/login',
            '/pythonezltxa1d/forecast',
        ]  # 免认证list
        ...
        post_list = [
            '/pythonezltxa1d/defaultuser/register',
            '/pythonezltxa1d/defaultuser/login',
            '/pythonezltxa1d/users/register',
            '/pythonezltxa1d/users/login',
            "/pythonezltxa1d/examusers/login" ,
            "/pythonezltxa1d/examusers/register"
        ]  # 免认证list
